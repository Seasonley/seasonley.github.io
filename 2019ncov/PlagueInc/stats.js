(function(b) {
  ...
  MtaH5.hack = function() {
    ...
    if (0 == b.length)
      for (
        var l = document.getElementsByTagName("script"), k = 0;
        k < l.length;
        k++
      )
        if (
          "undefined" !== typeof l[k].attributes.name &&
          "MTAH5" == l[k].attributes.name.nodeValue
        ) {
          b = [];
          b.push(l[k]);
          break;
    ...
    0 < b.length &&
      (function() {
        "undefined" !== typeof b[0].attributes.sid &&
          (f.conf.sid = b[0].attributes.sid.nodeValue);
        "undefined" !== typeof b[0].attributes.cid &&
          (f.conf.cid = b[0].attributes.cid.nodeValue);
        "object" === typeof _mtac &&
          (function() {
            for (var b in _mtac)
              if ("ignoreParams" == b) {
                ...
                "object" == typeof _mtac[b] &&
                  0 < _mtac[b].length &&
                  _mtac.hasOwnProperty(b) &&
                  (f.conf[b] = _mtac[b]);
        ...
        "object" === typeof _user &&
          (function() {
            for (var b in _user)
              f.user.hasOwnProperty(b) && (f.user[b] = _user[b]);
          })();
      })();
    f.conf.user = f.user;
...
(function(b, q) {
  ...
  function l(a, b, e) {
    if (window.localStorage)
      ...
      var d = window.location.host,
        ...
        g = d.split(".");
      2 < g.length &&
        (d = (f[g.slice(-2).join(".")] ? g.slice(-3) : g.slice(-2)).join("."));
      document.cookie =
  ...
  function k(a) {
      ...
      for (var a = g.split("&"), e = [], d = 0, h = a.length; d < h; d++)
        if (-1 != a[d].indexOf("=")) {
          var c = a[d].indexOf("="),
            f = a[d].slice(0, c);
          c = a[d].slice(c + 1);
          (b.ignoreParams && -1 != b.ignoreParams.indexOf(f)) ||
            e.push(f + "=" + c);
        }
      return e.join("&");
    })();
    h &&
      (function() {
        for (
          var a = 0 == h.indexOf("#") ? h.substr(1).split("&") : h.split("&"),
            b = 0,
            d = a.length;
          b < d;
          b++
  ...
  function r() {
    ...
    d.pvi = (function() {
      if (b.userReport) {
        ...
        (a && a == b.user.user_id) ||
          ((d.ty = 1),
          l("pgv_uid", b.user.user_id, "Sun, 18 Jan 2038 00:00:00 GMT;"));
        a = b.user.user_id;
      } else
        (a = f("pgv_pvi")),
          a ||
            ((d.ty = 1),
            (a = w(void 0)),
            l("pgv_pvi", a, "Sun, 18 Jan 2038 00:00:00 GMT;"));
      return a;
    })();
    d.si = (function() {
      var a = f("pgv_si");
    ...
    d.url = (function() {
      ...
      b.senseQuery &&
        (d += a.search
          ? "?" + encodeURIComponent(a.search || "").substr(0, 512)
          : "");
  ...
  function t() {
    try {
      var a = navigator,
        b = screen || { width: "", height: "", colorDepth: "" },
        e = {
  ...
  function u(a) {
    ...
    if (a) {
      ...
      for (c in a)
        a.hasOwnProperty(c) &&
          e.push(encodeURIComponent(c) + "=" + encodeURIComponent(a[c]));
      a = e.join(";");
      b.ext = a;
    }
    return arr;
  ...
  function x(a) {
    ...
    if (b.sid)
      if (
        !b.userReport ||
        (b.user.user_id && !parseInt(b.user.user_id, 10) !== b.user.user_id)
      ) {
        a = [];
        for (
          var e = 0,
          ...
          for (d in c[e])
            c[e].hasOwnProperty(d) &&
              a.push(d + "=" + ("undefined" == typeof c[e][d] ? "" : c[e][d]));
        var g = function(a) {
          a = Ta.src =
          ...
          ((d = function() {
            if (window.performance) {
              ...
              var d = { value: a.connectEnd - a.connectStart },
                e = {
                  value:
                    a.responseStart - (a.requestStart || a.responseStart + 1)
                },
            ...
            for (var k = f.length; e < k; e++)
              for (var n in f[e])
                f[e].hasOwnProperty(n) &&
                  a.push(
                    n + "=" + ("undefined" == typeof f[e][n] ? "" : f[e][n])
                  );
            for (n in c)
              c.hasOwnProperty(n) &&
                ("domContentLoadedTime" == n
                  ? a.push("r3=" + c[n].value)
                  : d.push(c[n].value));
  ...
  Ta.clickStat = MtaH5.clickStat = function(a, d) {
    ...
    if (c.cid) {
      ...
      for (h = g.length; k < h; k++)
        for (var m in g[k])
          g[k].hasOwnProperty(m) &&
            f.push(m + "=" + ("undefined" == typeof g[k][m] ? "" : g[k][m]));
      f = MtaH5.src =
        ("https:" == document.location.protocol
          ? "https://pingtas.qq.com/webview"
          : "http://pingtcss.qq.com") +
  ...
  Ta.clickShare = MtaH5.clickShare = function(a) {
    ...
    if (e.cid) {
      ...
      for (h = g.length; a < h; a++)
        for (var l in g[a])
          g[a].hasOwnProperty(l) &&
            c.push(l + "=" + ("undefined" == typeof g[a][l] ? "" : g[a][l]));
      l = MtaH5.src =
        ("https:" == document.location.protocol
          ? "https://pingtas.qq.com/webview"
          : "http://pingtcss.qq.com") +
